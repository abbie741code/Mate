    ...
    <div class="wrapall">
        ...
        <div class="kk-user-photo-glow">
            <div class="user_photo btn-4">
                <a href="Member_personal-data.php"><img src="imgs/people/selfie43.JPG" alt="" id="userPic"></a>
            </div>

        </div>

        <p class="user_name" id="userName">Ajax</p>
        <h6 class="user_age" id="userAge">32歲</h6>
        <div class="border-image">
            <p class="user_career" id="userOccupation">UX Researcher</p>
        </div>

        <div class="keyword_all">
            <div class="line1">
                <h6 class="keyword" id="userHobby1">麥當勞</h6>
                <h6 class="keyword" id="userHobby2">健身</h6>
                <h6 class="keyword" id="userHobby3">衝浪</h6>
            </div>
            <div class="line2">
                <h6 class="keyword" id="userHobby4">可樂</h6>
                <h6 class="keyword" id="userHobby5">看書</h6>
            </div>
        </div>
        ...
        <div class="coin_all">
            <div class="left">
                ...
                <h6 class="coinword2" id="userTokenAmount">120 個</h6>
            </div>
